...
decisions = Decision.create!([
  {name: "Gate Lock", description: "We decided that the lock on the gate at Faye St should be a combination lock instead of a key lock. This way folks who need to access the land (for instance Daniel S. who sometimes mows), can easily do so without arranging for someone with a key to meet them or unlock it prior. Anthony can be contacted for the combination.",  date_decided: Date.new(2015,9,17), circle_id: Circle.find_by(name: "Land Stewardship").id, supp_doc_one_type: "Minutes", supp_doc_one_link: "https://hartsmill.onlyoffice.com/products/files/doceditor.aspx?fileid=4579533", is_incorporated: true},

  {name: "Childcare at Events", description: "We decided to have childcare at our social events and workdays for the next few months. Hopefully this will encourage folks with small children to get to know us better and allow us to show our commitment to inclusvity.", date_decided: Date.new(2015,9,3), circle_id: Circle.find_by(name: "Membership and Marketing").id, supp_doc_one_type: "Minutes", supp_doc_one_link: "https://hartsmill.onlyoffice.com/products/files/doceditor.aspx?fileid=4558441", is_incorporated: true},

  {name: "Membership Exit Procedures", description: "Outlines procedures for members to leave Hart's Mill under a variety of circumstances.", date_decided: Date.new(2015,7,9), circle_id: Circle.find_by(name: "Membership and Marketing").id, supp_doc_one_type: "Proposal", supp_doc_one_link: "https://hartsmill.onlyoffice.com/products/files/doceditor.aspx?fileid=4486220", is_incorporated: true},

  {name: "Upgrade toilet (officially, 'A Really Shitty Decision')", description: "We resolved to upgrade toilet facilities with some sort of moveable wooden outhouse. Anthony will work this into planning for spring.", date_decided: Date.new(2015,7,9), circle_id: Circle.find_by(name: "Land Stewardship").id, supp_doc_one_type: "Minutes", supp_doc_one_link: "https://hartsmill.onlyoffice.com/products/files/doceditor.aspx?fileid=4626376", is_incorporated: true}
  ])
